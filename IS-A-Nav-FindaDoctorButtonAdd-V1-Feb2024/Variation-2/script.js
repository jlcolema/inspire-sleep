...
function findADoctorUPDATE() {
  ...
  secondaryMenu.forEach(menu => {
    ...
    if (menu.classList.contains('secondary-navbar')) {
      ...
      clonedFindADoctorNavItem.querySelector('a').classList.add('btn');
      clonedFindADoctorNavItem.querySelector('a').setAttribute('id', 'btn--find-a-doctor');
    }
  });
...
try {
  ...
  const e = {
    dev: 'U05C4LLSK6G',
    vwotest: '6',
    vwodesc: 'IS-A-Nav-FindaDoctorButtonAdd-V1-Feb2023 - Variation 2',
    type: 'vwo',
